...
import { useContractContext } from "../../../../Employee/pages/contract/ContractContext";
  ...
  const baseColumns: ColumnsType<ContractResponse> = useMemo(
    () => [
      ...
      },
      {
        ...
        align: "center",
        fixed: "left",
        render: (contractCode: string, record) => (
          <a
            href="#"
            onClick={(e) => {
              e.preventDefault();
    ...
    [dataResponse?.pagination.page, dataResponse?.pagination.limit, navigate],
  );
