...
const DataTable = () => {
    ...
    const baseColumns: ColumnsType<EMPLOYEE> = useMemo(
        ...
        [dataResponse?.data.pagination.page, dataResponse?.data.pagination.limit, setSelectedEmployee, setPopupUpdateEmployee]
    );
    ...
    const paginationConfig = useMemo(
        ...
        [dataResponse?.data.pagination.total, dataResponse?.data.pagination.limit, dataResponse?.data.pagination.page]
    );
