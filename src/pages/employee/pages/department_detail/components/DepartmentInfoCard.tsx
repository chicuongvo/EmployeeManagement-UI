  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 mb-4">
        {!isEditable ? (
          <span className="text-[28px] font-bold text-zinc-800">
            {department.name}
          </span>
        ) : (
          <Form.Item name="name" className="mb-0" style={{ flex: 1 }}>
            <Input
              ...
              className="text-[24px] font-bold h-10"
            />
          </Form.Item>
        )}
        {!isEditable ? (
      ...
      {!isEditable ? (
        <div className="mb-6 pr-2">
          <p
            className={`text-sm text-zinc-600 leading-relaxed text-justify ${!expanded ? "line-clamp-4" : ""}`}
          >
          ...
          {department.description && department.description.length > 150 && (
            ...
            >
              <span className="text-righ text-xs">
        ...
        <div className="flex items-start gap-3 col-span-2">
          ...
          <div className="flex flex-col gap-1 flex-1">
            ...
            {!isEditable ? (
              department.manager ? (
                <Link
                  to={`/management/employees/${department.manager.id}`}
